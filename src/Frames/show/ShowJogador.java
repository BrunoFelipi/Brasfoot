 ...
 * @author bruno.souza
 */
public class ShowJogador extends javax.swing.JDialog {

    private Jogador j;
    
    public ShowJogador(java.awt.Frame parent, Jogador j) {
        super(parent, true);
        initComponents();
        this.j = j;
        preencherCampos();
        //setTitle(this.j.getId() + " - " + j.getNome() + "(" + j.getNumero() + ")");
    ...
    private void initComponents() {
        ...
        campoHabilidade1 = new javax.swing.JTextField();
        campoHabilidade2 = new javax.swing.JTextField();
        campoIdade = new javax.swing.JTextField();
        campoForca = new javax.swing.JTextField();
        campoStatus = new javax.swing.JTextField();
        campoCraque = new javax.swing.JTextField();
        ...
        campoTime.setEnabled(false);

        campoHabilidade1.setEnabled(false);

        campoHabilidade2.setEnabled(false);

        campoIdade.setEnabled(false);

        campoForca.setEnabled(false);

        campoStatus.setEnabled(false);

        campoCraque.setEnabled(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblNome, javax.swing.GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE))
        );
        ...
        campoValor.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(campoHabilidade2)
                            .addComponent(campoHabilidade1)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jLabel11, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 62, Short.MAX_VALUE)
                            .addComponent(jLabel10, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(campoStatus)
                            .addComponent(campoCraque)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(campoHabilidade1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(campoHabilidade2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(campoCraque, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void preencherCampos(){        
        ...
        campoPosicao.setText(j.getPosicao() + "");
        campoNumero.setText(j.getNumero() + "");
        campoTime.setText(j.getTime().getNome());
        campoHabilidade1.setText(j.getHabilidade1().name());
        campoHabilidade2.setText(j.getHabilidade2().name());
    ...
    private javax.swing.JTextField campoCraque;
    private javax.swing.JTextField campoForca;
    private javax.swing.JTextField campoHabilidade1;
    private javax.swing.JTextField campoHabilidade2;
