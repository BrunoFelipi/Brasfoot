...
public class CadastrarTime extends javax.swing.JDialog {
    ...
    public CadastrarTime(BancoDeDados bd, EditarTimes et) {
        ...
        setBd(bd); 
        setEt(et);
        this.img24 = new ImageIcon(getClass().getResource("/resources/escudo/24/7.png"));
        this.img32 = new ImageIcon(getClass().getResource("/resources/escudo/32/7.png"));
        this.img128 = new ImageIcon(getClass().getResource("/resources/escudo/128/7.png"));
    ...
    private void initComponents() {
        ...
        btnAddEstadio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddEstadioActionPerformed(evt);
            }
        });
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGap(158, 158, 158))
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(comboTreinador, 0, 112, Short.MAX_VALUE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(comboNivel, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            ...
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    .addComponent(campoId, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
                                                    .addComponent(campoNome)))
                                            .addComponent(jLabel7)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(campoCor1, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if(campoNome.getText().isEmpty()){
            ...
            this.lblNok.setVisible(false);
            this.lblNok.setToolTipText("Time \"" + campoNome.getText() + "\" cadastrado com sucesso!");
            limparCampos();
        }
...
//        }
    ...
    private void btnAddEstadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEstadioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnAddEstadioActionPerformed
