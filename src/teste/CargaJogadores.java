...
public class CargaJogadores {
    ...
    public void inserirJogadores(){
        ...
        j1.setTime(new Time(img24Time, img32Time, img128Time, 1, "Time 1", EnumNivel.Continental, new Treinador("Treinador 1", 50, 45), new Estadio("Estadio 1"), Color.BLUE, Color.GRAY, this.bd));
        ...
        j2.setTime(new Time(img24Time, img32Time, img128Time, 2,  "Time 2", EnumNivel.Continental, new Treinador("Treinador 2", 50, 45), new Estadio("Estadio 2"), Color.ORANGE, Color.yellow, this.bd));
        ...
        j3.setTime(new Time(img24Time, img32Time, img128Time, 3,  "Time 3", EnumNivel.Continental, new Treinador("Treinador 3", 50, 45), new Estadio("Estadio 3"), Color.CYAN, Color.BLACK, this.bd));
        ...
        j4.setTime(new Time(img24Time, img32Time, img128Time, 4,  "Time 4", EnumNivel.Continental, new Treinador("Treinador 4", 50, 45), new Estadio("Estadio 4"), Color.green, Color.GRAY, this.bd));
        ...
        j5.setTime(new Time(img24Time, img32Time, img128Time, 5,  "Time 5", EnumNivel.Continental, new Treinador("Treinador 5", 50, 45), new Estadio("Estadio 5"), Color.DARK_GRAY, Color.BLACK, this.bd));        
        ...
        j6.setTime(new Time(img24Time, img32Time, img128Time, 6,  "Time 1", EnumNivel.Nacional, new Treinador("Treinador 1", 50, 45), new Estadio("Estadio 6"), Color.YELLOW, Color.WHITE, this.bd));
        ...
        j7.setTime(new Time(img24Time, img32Time, img128Time, 7,  "Time 2", EnumNivel.Nacional, new Treinador("Treinador 2", 50, 45), new Estadio("Estadio 7"), Color.PINK, Color.BLUE, this.bd));
        ...
        j8.setTime(new Time(img24Time, img32Time, img128Time, 8,  "Time 3", EnumNivel.Nacional, new Treinador("Treinador 3", 50, 45), new Estadio("Estadio 8"), Color.RED, Color.WHITE, this.bd));
        ...
        j9.setTime(new Time(img24Time, img32Time, img128Time, 9,  "Time 4", EnumNivel.Estadual, new Treinador("Treinador 4", 50, 45), new Estadio("Estadio 9"), Color.BLUE, Color.RED, this.bd));
        ...
        j10.setTime(new Time(img24Time, img32Time, img128Time, 10,  "Time 5", EnumNivel.Continental, new Treinador("Treinador 5", 50, 45), new Estadio("Estadio 10"), Color.CYAN, Color.MAGENTA, this.bd));        
        ...
        j11.setTime(new Time(img24Time, img32Time, img128Time, 11,  "Time 1", EnumNivel.Municipal, new Treinador("Treinador 1", 50, 45), new Estadio("Estadio 11"), Color.yellow, Color.YELLOW, this.bd));
        ...
        j12.setTime(new Time(img24Time, img32Time, img128Time, 12,  "Time 2", EnumNivel.Estadual, new Treinador("Treinador 2", 50, 45), new Estadio("Estadio 12"), Color.GREEN, Color.BLUE, this.bd));
        ...
        j13.setTime(new Time(img24Time, img32Time, img128Time, 13,  "Time 3", EnumNivel.Mundial, new Treinador("Treinador 3", 50, 45), new Estadio("Estadio 13"), Color.DARK_GRAY, Color.GRAY, this.bd));
        ...
        j14.setTime(new Time(img24Time, img32Time, img128Time, 14,  "Time 4", EnumNivel.Continental, new Treinador("Treinador 4", 50, 45), new Estadio("Estadio 14"), Color.WHITE, Color.BLACK, this.bd));
        ...
        j15.setTime(new Time(img24Time, img32Time, img128Time, 15,  "Time 5", EnumNivel.Nacional, new Treinador("Treinador 5", 50, 45), new Estadio("Estadio 15"), Color.GREEN, Color.green, this.bd));        
        ...
        j16.setTime(new Time(img24Time, img32Time, img128Time, 16,  "Time 1", EnumNivel.Continental, new Treinador("Treinador 1", 50, 45), new Estadio("Estadio 16"), Color.red, Color.GRAY, this.bd));
        ...
        j17.setTime(new Time(img24Time, img32Time, img128Time, 17,  "Time 2", EnumNivel.Estadual, new Treinador("Treinador 2", 50, 45), new Estadio("Estadio 17"), Color.cyan, Color.WHITE, this.bd));
        ...
        j18.setTime(new Time(img24Time, img32Time, img128Time, 18,  "Time 3", EnumNivel.Municipal , new Treinador("Treinador 3", 50, 45), new Estadio("Estadio 18"), Color.PINK, Color.YELLOW, this.bd));
        ...
        j19.setTime(new Time(img24Time, img32Time, img128Time, 19,  "Time 4", EnumNivel.Nacional, new Treinador("Treinador 4", 50, 45), new Estadio("Estadio 19"), Color.yellow, Color.BLUE, this.bd));
        ...
        j20.setTime(new Time(img24Time, img32Time, img128Time, 20,  "Time 5", EnumNivel.Continental, new Treinador("Treinador 5", 50, 45), new Estadio("Estadio 20"), Color.BLUE, Color.WHITE, this.bd));
