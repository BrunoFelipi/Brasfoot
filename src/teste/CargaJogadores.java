...
public class CargaJogadores {
    ...
    public void inserirJogadores(){
        ...
        Jogador j1 = new Jogador(1, img16Jog, img24Jog, img128Jog, "Teste 1", EnumPosicao.GL, 20, 1, EnumHabilidade.Reflexo, EnumHabilidade.DefesaPenalti, EnumStatus.EmAlta, "Não", this.bd, 5000, true);                
        ...
        Jogador j2 = new Jogador(2, img16Jog, img24Jog, img128Jog, "Teste 2", EnumPosicao.LT, 21, 2, EnumHabilidade.Cruzamento, EnumHabilidade.Passe, EnumStatus.EmAlta, "Não", this.bd, 5000, true);
        ...
        Jogador j3 = new Jogador(3, img16Jog, img24Jog, img128Jog, "Teste 3", EnumPosicao.ZG, 21, 3, EnumHabilidade.Cabeceio, EnumHabilidade.Marcação, EnumStatus.LevementeLesionado, "Sim", this.bd, 5000, true);
        ...
        Jogador j4 = new Jogador(4, img16Jog, img24Jog, img128Jog, "Teste 4", EnumPosicao.ZG, 22, 4, EnumHabilidade.Desarme, EnumHabilidade.Cabeceio, EnumStatus.DepartamentoMedico, "Não", this.bd, 5000, true);
        ...
        Jogador j5 = new Jogador(5, img16Jog, img24Jog, img128Jog, "Teste 5", EnumPosicao.MC, 23, 5, EnumHabilidade.Passe, EnumHabilidade.Finalização, EnumStatus.EmAlta, "Não", this.bd, 5000, true);
        ...
        Jogador j6 = new Jogador(6, img16Jog, img24Jog, img128Jog, "Teste 6", EnumPosicao.LT, 24, 6, EnumHabilidade.Resistencia, EnumHabilidade.BolaParada, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j7 = new Jogador(7, img16Jog, img24Jog, img128Jog, "Teste 7", EnumPosicao.MC, 25, 7, EnumHabilidade.Armação, EnumHabilidade.Armação, EnumStatus.DepartamentoMedico, "Não", this.bd, 5000, true);
        ...
        Jogador j8 = new Jogador(8, img16Jog, img24Jog, img128Jog, "Teste 8", EnumPosicao.MC, 26, 8, EnumHabilidade.Velocidade, EnumHabilidade.Finalização, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j9 = new Jogador(9, img16Jog, img24Jog, img128Jog, "Teste 9", EnumPosicao.AT, 27, 9, EnumHabilidade.Velocidade, EnumHabilidade.Finalização, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j10 = new Jogador(10, img16Jog, img24Jog, img128Jog, "Teste 10", EnumPosicao.MC, 28, 10, EnumHabilidade.Armação, EnumHabilidade.Velocidade, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j11 = new Jogador(11, img16Jog, img24Jog, img128Jog, "Teste 11", EnumPosicao.AT, 29, 11, EnumHabilidade.Drible, EnumHabilidade.Drible, EnumStatus.LevementeLesionado, "Não", this.bd, 5000, true);
        ...
        Jogador j12 = new Jogador(12, img16Jog, img24Jog, img128Jog, "Teste 12", EnumPosicao.GL, 22, 12, EnumHabilidade.Elasticidade, EnumHabilidade.SaidaGol, EnumStatus.Suspenso, "Sim", this.bd, 5000, true);
        ...
        Jogador j13 = new Jogador(13, img16Jog, img24Jog, img128Jog, "Teste 13", EnumPosicao.AT, 24, 13, EnumHabilidade.Drible, EnumHabilidade.Finalização, EnumStatus.EmAlta, "Não", this.bd, 5000, true);
        ...
        Jogador j14 = new Jogador(14, img16Jog, img24Jog, img128Jog, "Teste 14", EnumPosicao.AT, 26, 14, EnumHabilidade.Velocidade, EnumHabilidade.Finalização, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j15 = new Jogador(15, img16Jog, img24Jog, img128Jog, "Teste 15", EnumPosicao.MC, 28, 15, EnumHabilidade.Armação, EnumHabilidade.Passe, EnumStatus.EmAlta, "sim", this.bd, 5000, true);
        ...
        Jogador j16 = new Jogador(16, img16Jog, img24Jog, img128Jog, "Teste 16", EnumPosicao.MC, 24, 16, EnumHabilidade.Finalização, EnumHabilidade.Velocidade, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j17 = new Jogador(17, img16Jog, img24Jog, img128Jog, "Teste 17", EnumPosicao.ZG, 23, 17, EnumHabilidade.Desarme, EnumHabilidade.Marcação, EnumStatus.EmAlta, "Não", this.bd, 5000, true);
        ...
        Jogador j18 = new Jogador(18, img16Jog, img24Jog, img128Jog, "Teste 18", EnumPosicao.ZG, 21, 18, EnumHabilidade.Velocidade, EnumHabilidade.Marcação, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j19 = new Jogador(19, img16Jog, img24Jog, img128Jog, "Teste 19", EnumPosicao.LT, 20, 19, EnumHabilidade.Resistencia, EnumHabilidade.Cabeceio, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
        ...
        Jogador j20 = new Jogador(20, img16Jog, img24Jog, img128Jog, "Teste 20", EnumPosicao.LT, 20, 20, EnumHabilidade.Velocidade, EnumHabilidade.Finalização, EnumStatus.EmAlta, "Sim", this.bd, 5000, true);
